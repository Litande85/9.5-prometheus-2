...
#Добавление Node Exporter и в Prometheus и подключение Prometheus к Alertmanager через редактирование конфиг файла
sudo cp /home/user/prometheus/prometheus.yml /etc/prometheus/prometheus.yml

#Добавление правила оповещения

sudo cp /home/user/prometheus/netology-test.yml /etc/prometheus/netology-test.yml

#включить выгрузку данных на хосте с  Docker с помощью файла daemon.json:

sudo cp /home/user/prometheus/daemon.json /etc/docker/daemon.json
